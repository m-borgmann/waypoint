...
description: Reviews an implementation for quality, simplicity, and readiness to ship. Produces Review Findings.
disable-model-invocation: true
---

# Review

**Fourth core action** of the *waypoint* workflow. Evaluates whether the implementation fulfils the **Alignment Brief** and **Implementation Plan** using the simplest implementation that correctly solves the problem.
...
5. Produce **Review Findings** using waypoints `util-artifact` skill.
...
- **Review Findings** have been produced.
